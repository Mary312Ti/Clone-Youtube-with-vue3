    ...
    <header class="flex justify-between bg-white sticky top-0 z-50">
        <div class="lg:w-1/4 xl:w-64 flex">
            <div class="flex items-center pl-4">
                ...
                <a href="/">
                    <svg class="w-20" viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet"
        ...
        <div class="hidden p-2.5 sm:flex flex-1 gap-2 justify-end pl-8 md:pl-12 md:px-8 lg:px-0 items-center lg:w-1/2">
            <div class="hidden sm:flex w-full h-full max-w-screen-md">
                ...
                <button
                    class="flex items-center px-6 py-2 text-gray-600 bg-gray-100 border border-l-0 focus:outline-none border-gray-300 rounded-tr-3xl rounded-br-3xl hover:bg-gray-200">
        ...
        <div class="mt-2 z-20 sm:m-0 sm:space-x-8 flex items-center justify-end lg:w-1/4 pr-4 px-4">
            ...
            <button class="whitespace-nowrap text-blue-600 flex items-center border border-gray-300 rounded-3xl p-1 pr-3.5">
                <svg class="mr-2 w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
