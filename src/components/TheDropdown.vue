            ...
            <ul>
                <li>
                    <a href="#" class="flex items-center px-3 py-2 text-sm hover:bg-gray-100">
                        ...
                        <span class="pl-2">Apperance</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-4 h-4 text-gray-600 ml-auto">
                ...
                <li>
                    <a href="#" class="flex items-center px-3 py-2 text-sm hover:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-6 h-6 text-gray-600"
                            fill="#4b5563">
                            <path
                        ...
                        <span class="pl-2">Keyboard shortcuts</span>
                    </a>
                </li>
            </ul>
        </section>
                ...
                <ul>
                    ...
                    <li>
                        <a href="#" class="flex items-center px-3 py-2 text-sm hover:bg-gray-100">
                            ...
                            <span class="pl-2">Send feedback</span>
                        </a>
                    </li>
                </ul>
            </section>
