      ...
      <section class="">
        <ul>
          ...
          <li>
            <a
              href="#"
              class="flex items-center flex-col ml-2 px-4 py-6 font-semibold text-gray-800 hover:bg-gray-100 rounded-3xl"
            >
              <svg
                class="w-6 h-6"
          ...
          <li>
            <a
              href="#"
              class="rounded-3xl flex items-center flex-col ml-2 px-4 py-6 hover:bg-gray-100"
            >
