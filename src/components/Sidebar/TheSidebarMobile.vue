<template>
    <div class="hidden fixed inset-0 bg-black bg-opacity-50 z-30">
      <aside class="overflow-auto w-64 max-h-screen bg-white">
        <div class="flex py-4 pl-4 sticky top-0 bg-white">
        ...
        <section class="py-2 border-b">
          <ul>
            <li rounded-3xl>
              <a
                href="#"
                class="flex items-center px-6 py-2 text-sm font-semibold text-gray-800 bg-gray-200 hover:bg-300 rounded-3xl"
              >
                <svg
                  class="w-6 h-6 mr-6"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <a
                href="#"
                class="rounded-3xl flex items-center px-6 py-2 text-sm hover:bg-gray-100"
              >
                <svg class="w-6 h-6 mr-6" viewBox="0 0 24 24">
                  <path
        ...
        <section class="px-6 py-4 border-b leading-5">
          ...
          >
          <button
            class="text-blue-600 flex items-center border border-gray-300 rounded-3xl p-1 pr-3.5 px-2 mt-3"
          >
            <svg
              class="mr-2 w-7 h-7"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <section class="py-2 border-b">
          <div class="px-6 pt-4 pb-1 text-base">
            Explore
          </div>
          <ul>
            <li>
          ...
          <ul>
            <li>
              <a
                ...
                class="rounded-3xl flex items-center px-6 py-2 text-sm hover:bg-gray-100"
              >
                <svg class="mr-2 w-7 h-7" viewBox="0 0 24 24">
                  <path
        ...
        <section
          class="px-6 py-4 text-xs font-semobold space-y-4 text-gray-800"
        >
          <div>
